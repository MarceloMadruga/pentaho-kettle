...
public class SwingSvgGC implements GCInterface {
  ...
  private SwingSvgGC( BufferedImage image, Graphics2D gc, ImageObserver observer,
  ...
  public SwingSvgGC( ImageObserver observer, Point area, int iconsize, int xOffset, int yOffset ) throws KettleException {
    this( new BufferedImage( area.x, area.y, BufferedImage.TYPE_INT_RGB ), null, observer,
      area, iconsize, xOffset, yOffset );
  }

  public SwingSvgGC( Graphics2D gc, Rectangle2D rect, int iconsize, int xOffset, int yOffset ) throws KettleException {
    this( null, gc, null,
